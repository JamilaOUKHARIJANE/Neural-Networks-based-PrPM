...
def preprocess_numericals(train_pref_suff, 
    ...
    resLabel_df_val = val_pref_suff[4]
    ...
    if outcome:
        ...
        train_pref_suff = prefix_df_train, suffix_df_train, timeLabel_df_train,actLabel_df_train, resLabel_df_train
        val_pref_suff = prefix_df_val, suffix_df_val,  timeLabel_df_val,actLabel_df_val, resLabel_df_val
        test_pref_suff = prefix_df_test, suffix_df_test,  timeLabel_df_test, actLabel_df_test, resLabel_df_test,
