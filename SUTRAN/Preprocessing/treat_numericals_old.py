...
def preprocess_numericals(train_pref_suff, 
    ...
    actLabel_df_train = train_pref_suff[2]
    resLabel_df_train = train_pref_suff[3]

    prefix_df_val = val_pref_suff[0]
    suffix_df_val = val_pref_suff[1]
    #timeLabel_df_val = val_pref_suff[2]
    actLabel_df_val = val_pref_suff[2]
    resLabel_df_val = val_pref_suff[3]

    prefix_df_test = test_pref_suff[0]
    suffix_df_test = test_pref_suff[1]
    #timeLabel_df_test = test_pref_suff[2]
    actLabel_df_test = test_pref_suff[2]
    resLabel_df_test = test_pref_suff[3]

    if outcome: 
        outcomeLabel_df_train, outcomeLabel_df_val, outcomeLabel_df_test = train_pref_suff[4], val_pref_suff[4], test_pref_suff[4]
        resLabel_df_train, resLabel_df_val, resLabel_df_test = train_pref_suff[5], val_pref_suff[5], test_pref_suff[5]
...
'''
    ...
    if outcome:
        train_pref_suff = prefix_df_train, suffix_df_train, actLabel_df_train, outcomeLabel_df_train, resLabel_df_train
        val_pref_suff = prefix_df_val, suffix_df_val, actLabel_df_val, outcomeLabel_df_val , resLabel_df_val
        test_pref_suff = prefix_df_test, suffix_df_test, actLabel_df_test, outcomeLabel_df_test, resLabel_df_test
    else:
        train_pref_suff = prefix_df_train, suffix_df_train, actLabel_df_train, resLabel_df_train
        val_pref_suff = prefix_df_val, suffix_df_val, actLabel_df_val, resLabel_df_val
        test_pref_suff = prefix_df_test, suffix_df_test, actLabel_df_test, resLabel_df_test,
