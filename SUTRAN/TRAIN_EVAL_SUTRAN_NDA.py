...
def train_eval(log_name, 
    ...
    num_resources = cardinality_dict['org:resource'] + 2
    ...
    model = SuTraN_no_context(num_activities=num_activities, num_resources = num_resources,
                        d_model=d_model, 
...
log_names= ['helpdesk']#,'BPI2013','BPI2012']

for log_name in log_names:
    train_eval(log_name, 0)